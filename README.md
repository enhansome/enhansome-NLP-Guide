...
[Intel® Neural Compressor](https://github.com/intel/neural-compressor) ⭐ 2,706 | 🐛 24 | 🌐 Python | 📅 2026-08-30 is a Low Precision Optimization Tool, targeting to provide unified APIs for network compression technologies, such as low precision quantization, sparsity, pruning, knowledge distillation, across different deep learning frameworks to pursue optimal inference performance.
