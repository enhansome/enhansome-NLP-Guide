...
[Intel® Neural Compressor](https://github.com/intel/neural-compressor) ⭐ 2,704 | 🐛 23 | 🌐 Python | 📅 2026-08-27 is a Low Precision Optimization Tool, targeting to provide unified APIs for network compression technologies, such as low precision quantization, sparsity, pruning, knowledge distillation, across different deep learning frameworks to pursue optimal inference performance.
