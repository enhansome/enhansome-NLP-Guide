...
[Intel® Neural Compressor](https://github.com/intel/neural-compressor) ⭐ 2,709 | 🐛 20 | 🌐 Python | 📅 2026-09-22 is a Low Precision Optimization Tool, targeting to provide unified APIs for network compression technologies, such as low precision quantization, sparsity, pruning, knowledge distillation, across different deep learning frameworks to pursue optimal inference performance.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,338 | 🐛 785 | 🌐 JavaScript | 📅 2026-09-22.
