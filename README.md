...
[Intel® Neural Compressor](https://github.com/intel/neural-compressor) ⭐ 2,707 | 🐛 24 | 🌐 Python | 📅 2026-09-07 is a Low Precision Optimization Tool, targeting to provide unified APIs for network compression technologies, such as low precision quantization, sparsity, pruning, knowledge distillation, across different deep learning frameworks to pursue optimal inference performance.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,440 | 🐛 1,183 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
