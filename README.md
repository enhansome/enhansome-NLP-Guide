...
[Intel® Neural Compressor](https://github.com/intel/neural-compressor) ⭐ 2,697 | 🐛 20 | 🌐 Python | 📅 2026-08-19 is a Low Precision Optimization Tool, targeting to provide unified APIs for network compression technologies, such as low precision quantization, sparsity, pruning, knowledge distillation, across different deep learning frameworks to pursue optimal inference performance.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,296 | 🐛 847 | 🌐 JavaScript | 📅 2026-08-19.
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,197 | 🐛 476 | 🌐 Julia | 📅 2026-08-19 is a Julia package for probability distributions and associated functions.
